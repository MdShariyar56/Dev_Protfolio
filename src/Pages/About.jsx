...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="relative overflow-hidden bg-[#030712] px-6 py-16 "
    >
      <DotGrid />
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="text-4xl font-black tracking-tight text-white md:text-6xl">
            About{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0095FF] to-blue-500">
              Me
            </span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="premium-moving-border w-full max-w-[280px] md:max-w-[320px] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.4)] md:top-26">
          ...
          >
            {/* ROLE TAG */}
            <div className="mb-5 inline-flex items-center gap-2.5 rounded-lg border border-[#0095FF]/10 bg-[#0095FF]/5 px-3 py-1">
            ...
            <div className="text-gray-400 text-sm md:text-[15px] leading-relaxed space-y-5 px-2 font-medium">
              <p>
                ...
                with strong expertise in modern UI development. Highly skilled
                in building responsive, user-friendly websites using{" "}
                <span className="font-semibold text-blue-400">
                  HTML5, CSS3, Tailwind/Bootstrap, JavaScript, and React
                </span>
                .
              </p>
              ...
              <p>
                ...
                , allowing me to implement basic full-stack functionality while
              ...
              <p>
                ...
                into polished, seamless digital experiences—always following
                best practices in performance, accessibility, and modern web
                standards.
              </p>
            </div>

            {/* STATS SECTION */}
            <div className="mt-6 flex rounded-2xl border border-white/5 bg-white/[0.01] backdrop-blur-sm">
            ...
            {/* DIVIDER */}
            <div className="my-6 h-px bg-gradient-to-r from-white/5 via-white/5 to-transparent" />
            ...
            >
              ...
              <motion.button
                ...
                whileHover={{
                  scale: 1.04,
                  y: -2,
                  boxShadow: "0 10px 36px rgba(0,149,255,0.5)",
                }}
                whileTap={{ scale: 0.97 }}
              >
                <motion.span
